...
<template>
  <div class=" bg-black text-white w-screen h-screen flex flex-col justify-center items-center">
    ...
    <p class="text-3xl max-w-lg text-center mb-14">By default sounds are turned OFF but you always can turn them ON from
      the terminal</p>
    <p class="text-2xl animate-pulse underline"> Press <span class="text-terminal-green-primary">ENTER</span>
      to get started</p>
  </div>
</template>