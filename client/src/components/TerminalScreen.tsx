...
const TerminalScreen: FC = (): React.JSX.Element => {
	...
	return (
		<div
			className={`z-0 relative terminal-screen max-w-[1200px] max-h-[calc(100%_-_5px)] mr-10 w-full h-full border-4 border-[#121212] shadow-[inset_0_0_3px_3px_#000000_,_0_0_3px_2px_#000000] rounded-[50px] transition-colors overflow-hidden text-terminal-main-primary bg-black ${
				power &&
